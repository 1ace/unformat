...
mutation_rules = {
    ...
    "AlwaysBreakTemplateDeclarations": make_choice("Yes", "No", "MultiLine"),
    ...
    "BreakInheritanceList": make_choice("BeforeColon", "AfterComma", "BeforeComma"),
    ...
    "IndentPPDirectives": make_choice("None", "AfterHash"),
